...
/**
 * Content for Blog Test documents
 */
interface BlogTestDocumentData {
	/**
	 * Slice Zone field in *Blog Test*
	 *
	...
	/**
	 * Meta Description field in *Blog Test*
	 *
	 * - **Field Type**: Text
...
/**
 * Blog Test document from Prismic
 *
 * - **API ID**: `blog_test`
 * - **Repeatable**: `true`
...
export type AllDocumentTypes = BlogTestDocument;
